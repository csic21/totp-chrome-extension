...
export class MigrationPayload extends pb_1.Message {
  ...
  static fromObject(data: {
    otp_parameters?: ReturnType<
      typeof MigrationPayload.OtpParameters.prototype.toObject
    >[];
    version?: number;
    batch_size?: number;
    batch_index?: number;
    ...
    if (data.otp_parameters != null) {
      message.otp_parameters = data.otp_parameters.map((item) =>
        MigrationPayload.OtpParameters.fromObject(item)
      );
    }
  ...
  toObject() {
    ...
    if (this.otp_parameters != null) {
      data.otp_parameters = this.otp_parameters.map(
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    ...
    if (this.batch_size != 0) writer.writeInt32(3, this.batch_size);
    if (this.batch_index != 0) writer.writeInt32(4, this.batch_index);
    if (this.batch_id != 0) writer.writeInt32(5, this.batch_id);
  ...
  export class OtpParameters extends pb_1.Message {
    ...
    get type() {
      return pb_1.Message.getFieldWithDefault(
        this,
        6,
        MigrationPayload.OtpType.OTP_INVALID
      ) as MigrationPayload.OtpType;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
      const writer = w || new pb_1.BinaryWriter();
      if (this.secret.length) writer.writeBytes(1, this.secret);
      if (this.name.length) writer.writeString(2, this.name);
      if (this.issuer.length) writer.writeString(3, this.issuer);
      if (this.algorithm != MigrationPayload.Algorithm.ALGO_INVALID)
        writer.writeEnum(4, this.algorithm);
      if (this.digits != 0) writer.writeInt32(5, this.digits);
      if (this.type != MigrationPayload.OtpType.OTP_INVALID)
        writer.writeEnum(6, this.type);
      if (this.counter != 0) writer.writeInt64(7, this.counter);
      if (!w) return writer.getResultBuffer();
    }
      ...
      while (reader.nextField()) {
        ...
        switch (reader.getFieldNumber()) {
          ...
          case 4:
            ...
            break;
          case 5:
            message.digits = reader.readInt32();
            break;
          case 6:
